...
export default function RecibosAsaPage() {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          title="Recibos Exclusivos"
          description="Gerencie seus recibos de pagamento exclusivos"
          action={{
            label: "Novo Recibo",
            onClick: () => router.push("/recibos-asa/novo"),
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <label className="inline-flex items-center gap-2 rounded-lg border border-border px-3 py-1.5 text-sm font-medium text-foreground hover:bg-muted cursor-pointer transition-colors">
                    {uploadingLogo ? (
                      ...
                      <TableCell>
                        <div className="flex items-center justify-end gap-1">
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => router.push(`/recibos-asa/${recibo.id}`)}
                            title="Ver recibo"
                          >
